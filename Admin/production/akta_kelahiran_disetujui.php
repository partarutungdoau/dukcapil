        ...
        <?php while($pecah = $get->fetch_assoc()){ ?>
            <tr>
                ...
                <td>
                  ...
                  <?php if ($pecah['status'] == "Diterima"):?>
                  <a href="index.php?halaman=indexxxx&id=<?php echo $pecah['id_kelahiran']; ?>" class="btn btn-info btn-xs"><i class="fa fa-paper-plane"></i> Kirim Email </a>
                 <?php endif ?>    
