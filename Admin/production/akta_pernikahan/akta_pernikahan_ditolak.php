...
<div class="x_content">
    <table class="table table-striped projects">
        ...
        <tbody>
        <?php $nomor=1; ?>
        <?php $get=$connect->query("SELECT * FROM perkawinan INNER JOIN status_request ON perkawinan.id_status_request=status_request.id_status WHERE id_status_request='3'"); ?>
                ...
                <td>
                    ...
                    <?php
                        if(isset($_POST['terima']))
                        {
                            ...
                            echo "<script> location='index.php?halaman=akta_kawin_disetujui'</script>";
                        }
                    ?>
                    <?php
                        if(isset($_POST['tolak']))
                        {
                            $connect->query("UPDATE perkawinan SET id_status_request='3' WHERE perkawinann.id_perkawinan='$_GET[id]'");

                            echo "<script> alert('Berhasil Ditolak);</script>";
                            echo "<script> location='index.php?halaman=akta_kawin_ditolak'</script>";
                        }
                    ?>    
                </td>
            </tr>      
