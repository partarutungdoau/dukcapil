...
<div class="x_content">
    <table class="table table-striped projects">
        ...
        <tbody>
        <?php $nomor=1; ?>
        <?php $get=$connect->query("SELECT * FROM perkawinan INNER JOIN status_request ON perkawinan.id_status_request=status_request.id_status WHERE id_status_request='5'"); ?>
