...
<div class="x_content">
    <table class="table table-striped projects">
        ...
        <tbody>
        <?php $nomor=1; ?>
        <?php $get=$connect->query("SELECT * FROM kelahiran INNER JOIN status_request ON kelahiran.id_status_request=status_request.id_status WHERE id_status_request='3'"); ?>
