	...
	<td>
		<table class="table1" border="0" width="90%">
			<tr class="head">
				...
				<td width="8%">:</td>
				<td width="22%"" align="left"><b><?php echo $detail_akta['no_kk']; ?></b></td>
				<td width="30%"></td>
				<td width="20%">No.<b><?php echo $detail_akta['id_kelahiran']; ?></b></td>
				<td></td>
			</tr>
			<tr>
			...
			<td colspan="3" ><b><?php echo $detail_akta['id_kelahiran']; ?></b></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="2"> <b><?php echo $detail_akta['tpt_lahir']; ?></b> </td>
				<td>Pada Tanggal</td>
			...
			<tr>
				<td colspan="6" align="center"><b><h3><?php echo $detail_akta['nama_lengkap_bayi']; ?></h3></b></td>
			</tr>
			<tr>
