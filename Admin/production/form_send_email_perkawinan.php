...
<div class="x_content">
    ...
    {
        $connect->query("UPDATE perkawinan SET id_status_request = '4' WHERE perkawinan.id_perkawinan ='$_GET[id]' ");
        echo "<script> alert('Berhasil Menerima);</script>";
        echo "<script> location='index.php?halaman=akta_perkawinan'</script>";
    }
    ?>
