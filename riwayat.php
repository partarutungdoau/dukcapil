        ...
        <div class="row">
          ...
          <div class="col-lg-6">
           ...
           <div class="col-lg-6">
            <div class="box wow fadeInLeft">
              <div class="icon"><i class="fa fa-bar-chart"></i></div>
              <h4 class="title"><a href="riwayat_kedatangan.php">Pencetakan Surat Penduduk Datang</a></h4>
              <p class="description"></p>
            </div>
           </div>
          ...
          <div class="col-lg-6">
            <div class="box wow fadeInLeft">
              <div class="icon"><i class="fa fa-bar-chart"></i></div>
              <h4 class="title"><a href="riwayat_akta_lahir.php">Akta Lahir</a></h4>
              <p class="description"></p>
            </div>
          </div>
          ...
          <div class="col-lg-6">
            <div class="box wow fadeInRight">
              ...
              <h4 class="title"><a href="riwayat_kematian.php">Akta Kematian</a></h4>
              <p class="description"></p>
            </div>
          </div>
          ...
          <div class="col-lg-6">
            <div class="box wow fadeInLeft" data-wow-delay="0.2s">
              ...
              <h4 class="title"><a href="riwayat_perkawinan.php">Pencetakan Surat Perkawinan</a></h4>
              <p class="description"></p>
            </div>
          </div>
          ...
          <div class="col-lg-6">
            <div class="box wow fadeInRight" data-wow-delay="0.2s">
              ...
              <h4 class="title"><a href="riwayat_perceraian.php">Pencetakan Surat Perceraian</a></h4>
              <p class="description"></p>
            </div>
          </div>
