  ...
  <body id="body">
    ...
    <?php
     ...
     <div class="container">
        <h3 align="center" class="mt-3">Riwayat Akte Lahir</h3>
        <div class="table-responsive">
          <table class="table table-striped table-bordered">
            ...
            <tbody>
               <?php
                ...
                $ambil = mysqli_query($conn, "SELECT * FROM kelahiran  inner join status_request m on id_status_request = id_status WHERE id_penduduk='$_SESSION[id_penduduk]'");
                while($pecah = $ambil->fetch_assoc()){
                ?>
                <tr>
                  <td><?php echo $nomor; ?></td>
                  <td><?php echo $pecah["nama_kepala_keluarga"]; ?></td>
                  <td><?php echo $pecah["nama_lengkap_bayi"]; ?></td>
          ...
          <a href="kelahiran.php" class="btn btn-primary">Request KK</a>
