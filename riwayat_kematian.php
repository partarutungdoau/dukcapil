    ...
    <?php
     ...
     <div class="container">
        ...
        <div class="table-responsive">
          <table class="table table-striped table-bordered">
            ...
            <tbody>
               <?php
                ...
                $ambil = mysqli_query($conn, "SELECT * FROM kematian  inner join status_request m on id_status_request = id_status WHERE id_penduduk='$_SESSION[id_penduduk]'");
                ...
                <tr>
                  ...
                  <td><?php echo $pecah["bulan_lahir"]; ?></td>
                  <td>
          ...
          <a href="kematian.php" class="btn btn-primary">Request KK</a>
