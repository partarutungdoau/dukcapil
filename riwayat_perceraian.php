    ...
    <?php
     ...
     <div class="container">
        ...
        <div class="table-responsive">
          <table class="table table-striped table-bordered">
            ...
            <tbody>
               <?php
                ...
                $ambil = mysqli_query($conn, "SELECT * FROM perceraian  inner join status_request m on id_status_request = id_status WHERE id_penduduk='$_SESSION[id_penduduk]'");
                while($pecah = $ambil->fetch_assoc()){
                ?>
                <tr>
                  <td><?php echo $nomor; ?></td>
                  <td><?php echo $pecah["nik_suami"]; ?></td>
                  <td><?php echo $pecah["nama_lengkap_suami"]; ?></td>
                  <td><?php echo $pecah["nik_istri"]; ?></td>
                  <td><?php echo $pecah["nama_lengkap_istri"]; ?></td>
                  <td>
          ...
          <a href="perceraian.php" class="btn btn-primary">Request Perceraian</a>
