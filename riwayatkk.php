...
<body id="body">
  ...
  <?php
   ...
   <div class="container">
        <h3 align="center" class="mt-3">Riwayat Request Kartu Keluarga</h3>
        <div class="table-responsive">
          <table class="table table-striped table-bordered">
            ...
            <tbody>
               <?php
                ...
                $ambil = mysqli_query($conn, "SELECT * FROM kartu_keluarga  inner join status_request m on id_status_request = id_status WHERE id_penduduk='$_SESSION[id_penduduk]'");
          ...
          <a href="kartu_keluarga.php" class="btn btn-primary">Request KK</a>
